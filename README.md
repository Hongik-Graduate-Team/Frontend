...
<table>
  ...
  <tr>
    ...
    <td align="center"><b>프로젝트 팀장 & 백엔드 개발</b></td>
    <td>
      <b>📌 프로젝트 팀장 역할</b><br>
      - 프로젝트 일정 조율<br>
      - 회의록 관리 및 문서 정리<br>
      ...
      - **API 개발**  
        - **사용자 포트폴리오 관리**  
          - 포트폴리오 각 카테고리별 CRUD 기능 구현  
        - **마이페이지 기능**  
          - 사용자 인터뷰 목록 조회 API  
          - 사용자 인터뷰 상세 조회 API  
        - **평가 및 AI 활용 기능**  
          - 사용자 시선 및 자세 평가 API  
          - 생성형 AI 기반 맞춤형 질문 생성 API  
        - **사용자 데이터 관리**  
          - 사용자 정보 조회 API  
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="center"><b>프론트엔드 개발 & 디자인</b></td>
    <td>
      <b>📌 프론트엔드 개발 역할</b><br>
      - **카카오 로그인 기능 개발**  
        - 카카오 회원가입 및 로그인 구현  
  ...
  <tr>
    ...
    <td>
      ...
      - **면접 준비, 진행 페이지 및 메인 페이지 공동 개발**  
        - 디자인 및 기능 구현  
        - 사용자 인터페이스 최적화  
      - **AI 기반 제스처 및 시선 분석 개발**  
        - Mediapipe API 활용하여 사용자의 시선 움직임 및 자세 분석  
    </td>
  </tr>
</table>
